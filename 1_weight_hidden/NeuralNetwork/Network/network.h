...
struct network
{
    ...
    struct matrice *hidden;
    struct matrice *hidden_biais;
...
struct network *Network_init(int input, int hidden, int output, void (*activation) (struct matrice*), double (*derivative_function)(double), int loaded);
